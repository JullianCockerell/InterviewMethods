...
public class InterviewMethods {
    ...
    public static String buildOrder(String[] projects, String[][] dependancies)
    {
        int pSize = projects.length;
        int dSize = dependancies.length;
        boolean[][] edges = new boolean[pSize][pSize];
